...
},{"./objects":3,"./windows":4}],3:[function(require,module,exports){
/**
...
Promise.all(Object.keys(Views).map(function (windowName) {
  return new Promise(function (resolve, reject) {
    // Get window data
    _overwolf["default"].windows.obtainDeclaredWindow(windowName, function (_ref) {
      var success = _ref.success,
          window = _ref.window; // Exit if failed
...
},{"../manifest.json":1,"./docs/overwolf":2,"./methods/Data":6}],6:[function(require,module,exports){
"use strict";
